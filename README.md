...
## Aim: There is no genome available for the gopher tortoise so here we aim to do so by assembling two separate genomes from two individuals that have either experienced a cold-dormancy winter or have not.
